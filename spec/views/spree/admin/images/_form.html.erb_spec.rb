...
describe 'spree/admin/images/_form.html.erb' do
  ...
  context 'product has variants' do
    ...
    xit 'shows an \'All\' checkbox with the product master variant id as value' do
      render
    ...
    xit 'shows checkboxes for selecting which variants will receive the uploaded image' do
      render
  ...
  context 'product does not have variants' do
    ...
    xit 'shows a select with a single option' do
      render
